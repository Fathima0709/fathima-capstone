...
public class FathimaMart {

    public static void main(String[] args) {

        JFrame frame = new JFrame("Fathima's Mart");
        ...
        JLabel title = new JLabel("🛒 Fathima Mart");
        title.setFont(new Font("Arial", Font.BOLD, 30));
        title.setForeground(new Color(102, 126, 234));
        title.setBounds(110, 40, 250, 40);
        panel.add(title);
...
class RegisterPage {
    ...
    RegisterPage() {
        ...
        JFrame frame =
                new JFrame("Fathima Mart - Register");
